...
export default function PopularDestinations() {
  ...
  const DESTINATION_IDS_BY_TAB = {
    India: new Set(['kerala', 'andaman', 'kashmir', 'manali', 'gangtok', 'taj-mahal', 'rajasthan', 'tamil-nadu', 'karnataka', 'odisha', 'meghalaya']),
    International: new Set(['dubai', 'bali', 'thailand', 'singapore', 'maldives', 'vietnam', 'sri-lanka', 'malaysia', 'bhutan', 'nepal']),
    Trending: new Set(['andaman', 'vietnam', 'sri-lanka', 'nepal', 'odisha', 'meghalaya', 'taj-mahal', 'rajasthan', 'kashmir', 'bhutan', 'karnataka']),
  };
  ...
  const displayedDestinations = isExpanded ? safeDestinations : safeDestinations.slice(0, 4);
            ...
            {safeDestinations.length > 4 && (
              <div className="mt-10 text-center">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-ink/20 bg-white px-8 py-3.5 text-xs font-bold uppercase tracking-wider text-ink shadow-soft hover:bg-ink hover:text-white hover:border-ink transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
                >
                  <span>{isExpanded ? 'Show Fewer Destinations' : `View All ${activeCategory} Destinations (${safeDestinations.length})`}</span>
                  <svg
