  ...
  useEffect(() => {
    ...
    if (metaDesc) {
      metaDesc.setAttribute(
        'content',
        'Blue Spice Holidays is a travel operator based in Ernakulam, Kochi, Kerala. Specialising in personalised domestic and international holidays since 2010.',
      );
    }
  }, []);
      ...
      <section className="relative bg-navy text-white py-28 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <span className="inline-block px-3 py-1 rounded-full text-[10px] font-semibold tracking-[0.2em] uppercase bg-gold/20 text-gold border border-gold/30 font-mono mb-5">
            Established 2010 · Ernakulam, Kochi
          </span>
          ...
          <p className="mt-5 text-white/70 max-w-xl mx-auto text-base sm:text-lg leading-relaxed">
            Founded in 2010 and headquartered in Ernakulam, Kochi, Blue Spice Holidays crafts personalised travel experiences for families, couples, and corporate travellers across India and the world.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          <div>
            ...
            <p className="text-body text-sm sm:text-base leading-relaxed mb-5">
              Blue Spice Holidays was established in 2010 in Ernakulam, Kerala, with a clear mission: to move beyond standard itineraries and offer genuinely enriching travel experiences. We are a fully registered travel operator based out of Kochi.
            </p>
            <p className="text-body text-sm sm:text-base leading-relaxed mb-5">
          ...
          <div className="bg-tint border border-hairline rounded-xl p-8">
            ...
            <ul className="space-y-3">
              {SERVICES.map((s) => (
                <li key={s} className="flex items-center gap-3 text-sm text-body">
      ...
      <section className="bg-canvas border-y border-hairline py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {PILLARS.map((p) => (
              <div key={p.title} className="bg-base rounded-xl border border-hairline p-7 shadow-soft flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-body text-sm leading-relaxed">{p.body}</p>
                </div>
              </div>
            ))}
          </div>
